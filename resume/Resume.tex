...
\begin{position}
  ...
  \item Fiat Cryptography is a developer tool to generate proven-correct cryptographic code. The project has wide industry adoption, including powering the plurality of secure connections in Google Chrome and Firefox
