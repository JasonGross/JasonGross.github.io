...
presentations/coqpl-2021/%.pdf: presentations/coqpl-2021/%.tex presentations/coqpl-2021/Makefile presentations/coqpl-2021/reification_by_type_inference_tex.v
	cd presentations/coqpl-2021; $(MAKE) $(*:=.pdf)
